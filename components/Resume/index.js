        ...
        sectionContent: [
            {
                ...
                entityContent: "Concentration in Digital Design, with coursework in information systems, software development, instructional design and digital production."
            },
            {
                entityTitle: "Northeastern University",
                entityLocation: "Boston, MA",
                entityDates: "Bachelor of Science in Business Administration, June 1998",
                entityContent: "Majored in International Business and Finance. Completed cooperative education assignments at Boston’s Better Snacks, FMRC and PictureTel with learning opportunities and responsibilities in operations, marketing, technical documentation and internationalization."
            },
        ]
    },
    {
        ...
        sectionContent: [
            ...
            },
            {
                ...
                entityLocation: "Boston, MA",
                entityDates: "September 2009 - December 2010, March 2012 - March 2013, June 2016 – June 2018",
                entityJob: "Senior User Experience Designer and Developer.",
                entityContent: "Responsible for assisting clients with web-based strategies, product research, design and development. Project engagements include working with Style Me Pretty on their upcoming website release, a ground-up overhaul of their existing products. Jay's responsibilities included working closely with the client to craft and implement a comprehensive experience strategy in addition to providing research, design and demonstration deliverables."
            },
            {
                ...
                entityJob: "Senior User Experience Designer and Developer.",
                entityContent: "Created an in-house CSS framework and reusable component library, provided design direction and development on multiple Cengage projects that included legacy code conversion, cross-platform CSS standardization, component design and user testing. In addition to his day to day responsibilities, Jay worked alongside senior management to define design and technical requirements for future platform releases."
            },
            {
                ...
                <h3>{elem.sectionTitle}</h3>
                    ...
                    <>
                        {elem.sectionContent.map((el, j) => (
                            <ul key={j}>
                                <li>{el.entityTitle}</li>
                                <li>{el.entityLocation}</li>
                                <li>{el.entityDates}</li>
                                <li>{el.entityJob}</li>
                                <li>{el.entityContent}</li>
                            </ul>
                        ))}
                    </>   
